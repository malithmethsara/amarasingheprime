    ...
    function displayResults(data) {
        ...
        const html = `
            ...
            <table style="width:100%;border-collapse:collapse;margin-bottom:1.5rem">
                ...
                <tbody>
                    <tr><td style="padding:0.5rem">Customs Duty</td><td style="text-align:right;padding:0.5rem">${formatNumber(data.cid)}</td></tr>
    ...
    function generatePDF(btn) {
        ...
        doc.autoTable({
            ...
            body: [
                ...
                ['Total Tax', formatNumber(resultData.totalTax)],
                ['Total Cost', formatNumber(resultData.totalCost)]
            ]
        });
